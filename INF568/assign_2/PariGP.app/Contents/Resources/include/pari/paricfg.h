...
#define UNIX
#define GPHELP "\"/bin/gphelp\""
#define GPDATADIR "/share/pari"
#define SHELL_Q '\''

#define PARIVERSION "GP/PARI CALCULATOR Version 2.9.1 (released)"
#define PARIINFO "i386 running darwin (x86-64/GMP-6.0.0 kernel) 64-bit version"
#define PARI_VERSION_CODE 133377
...
#define GCC_VERSION "Apple LLVM version 6.0 (clang-600.0.57) (based on LLVM 3.5svn)"
#define ASMINLINE
